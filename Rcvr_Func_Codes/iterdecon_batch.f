...
c
      ...
      integer MAXPTS, MAXG
      parameter(MAXPTS = 8192, MAXG = 600)
      real f(MAXPTS),g(MAXPTS),p(MAXPTS),r(MAXPTS)
      real amps(MAXG),perr(MAXG),differr(MAXG)
      integer shifts(MAXG)
      character*256 numerator, denominator, outfile, spikefile
...
c
c     write(stdout,*) ' '
c     write(stdout,*) 'Program iterdeconfd - Version 1.0X, 1997-98'
...
c
c TJO added an output file name for simplicity
c
...
c
      call sac_read(denominator,g,MAXPTS,denominator_header,nerr)
